...
the member name. */
SELECT DISTINCT B.memid, CONCAT( M.firstname, M.surname ) AS Name, F.name
FROM Bookings B
...
select facid, memid, slots, membercost, guestcost, sum(sub.Revenue)

FROM( SELECT b.facid,b.memid, b.slots, f.membercost, f.guestcost,
	
case when b.memid != 0 then f.membercost * b.slots
	 when b.memid = 0 then f.guestcost * b.slots
	 end as Revenue
		
from Bookings b INNER join Facilities f
on b.facid = f.facid
INNER JOIN Members m ON b.memid = m.memid)sub
group by facid

/* Q11: Produce a report of members and who recommended them in alphabetic surname,firstname order */
select m1.memid, m1.surname, m1.firstname, m2.recommendedby
